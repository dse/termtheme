    ...
    */
    ...
    var I = function(a, b, c) {
        ...
        Jb = function(a, b) {
            ...
            b instanceof Oa && b.constructor === Oa ? b = b.R : (za("expected object of type SafeHtml, got '" + b + "' of type " + ia(b)), b = "type_error:SafeHtml");
            e.innerHTML = b;
    ...
    var ac = function(a, b, c) {
        ...
        cc = function(a, b, c) {
            b && 0 < b.length && (b = bc(b), c && 0 < c.length && (b += "___" + bc(c)), 28 < b.length && (b = b.substr(0, 28) + (b.length - 28)), c = b, b = B($b, "_p", C()), B(b, c, C())[a] = (new Date).getTime(), ac(a, "_p", c))
        },
        bc = function(a) {
    ...
    var rc = decodeURI("%73cript"),
        ...
        uc = function() {
            var a = M.nonce;
            return void 0 !== a ? a && a === String(a) && a.match(sc) ? a : M.nonce = null : A.querySelector ? (a = A.querySelector("script[nonce]")) ? (a = a.nonce || a.getAttribute("nonce") || "", a && a === String(a) && a.match(sc) ? M.nonce = a : M.nonce = null) : null : null
        },
        xc = function(a) {
    ...
    var Dc = function(a) {
        ...
        Q = function(a, b, c) {
            if (b && "object" === typeof b)
                for (var d in b) !Object.prototype.hasOwnProperty.call(b, d) || c && "___goc" === d && "undefined" === typeof b[d] || (a[d] && b[d] && "object" === typeof a[d] && "object" === typeof b[d] && !Fc(a[d]) && !Fc(b[d]) ? Q(a[d], b[d]) : b[d] && "object" ===
        ...
        Ic = function(a) {
            ...
            for (e = 0; e < d.length; ++e) d[e].getAttribute("gapi_processed") ||
                (d[e].setAttribute("gapi_processed", !0), (f = d[e]) ? (g = f.nodeType, f = 3 == g || 4 == g ? f.nodeValue : f.textContent || "") : f = void 0, (f = Gc(f)) && b.push(f));
            a && Hc(c, a);
            d = Dc("cd");
            a = 0;
    ...
    Jd || (Nd = 1E6 * (screen.width * screen.width + screen.height), Od = Qd(A.cookie + "|" + A.location + "|" + (new Date).getTime() + "|" + Math.random()), Kd = U("random/maxObserveMousemove") || 0, 0 != Kd && Mb("mousemove", Pd, "add", "at"));
    var Rd = function() {
            var a = M.onl;
            if (!a) {
                a = C();
    ...
    var Vd = {
        ...
        Zd = function(a, b, c, d, e) {
            ...
            for (var h in c) a = c[h], "style" === h && "object" === typeof a ? E(a, f.style) : Wd[h] || f.setAttribute(h, String(a));
            ...
            Uc(function(b) {
                if (a !== b.id && 4 != b.state && "share" != b.type) {
                    ...
                    if (f) {
                        var g = le(d, b, 0);
                        g ? (f = f.parentNode,
                            pe(e) !== pe(g) && (b.dontclear = !0, b.rd = !0, b.ri = !0, b.type = d, qe(f, b), (d = T[f.lastChild.id]) && (d.oid = c), Vc(c, 4))) : delete T[c]
                    } else delete T[c]
                }
            })
        },
    ...
    var ze = function(a, b) {
        ...
        Ae = function(a, b, c, d) {
            ...
            for (f = 0; f < e.length; f++) {
                ...
                k && (ye[k] || 0 == g.nodeName.toLowerCase().indexOf("g:") || 0 != xb(oe(g)).length) && (g.setAttribute("data-gapiscan", !0), B(c, k, []).push(g))
            }
            if (b)
                for (var q in c)
            ...
            switch (Ke(b, a, f)) {
                ...
                case 1:
                    if (b.parentNode) {
                        ...
                        g = b = k;
                        $d.test(b) && (g = U("iframes/" + g.substring(1) + "/url"), F(!!g, "Unknown iframe url config for - " + b));
                ...
                if ("_renderstart" === d.s || d.s === Qe + "/" + a + "::_renderstart")
                    if (d = d.a && d.a[c ? 0 : 1], b = A.getElementById(a), Vc(a, 2), d && b && d.width && d.height) {
                        a: {
                            ...
                            "none";g.cssFloat = "none";g.styleFloat = "none";g.lineHeight = "normal";g.fontSize = "1px";g.verticalAlign = "baseline";c = c.style;c.display = "inline-block";g = b.style;g.position = "static";g.left = "0";g.top = "0";g.visibility = "visible";d && (c.width = g.width = d + "px");f && (c.height = g.height = f + "px");a.verticalAlign && (c.verticalAlign = a.verticalAlign);e && Vc(e, 3)
                        }
        ...
        Bc("auth", {
            callback: function() {
                ...
                d.checkSessionState(e, function(f) {
                    ...
                    if (k = k !== f) Jc("isLoggedIn", f), Tc(), re(), f || ((f = d.signOut) ? f() : (f = d.setToken) && f(null));
                    f = Oc();
